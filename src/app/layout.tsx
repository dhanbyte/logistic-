      ...
      <head>
        ...
        <Script id="meta-pixel" strategy="afterInteractive">
          {`
            ...
            fbq('init', '${process.env.NEXT_PUBLIC_META_PIXEL_ID || "1038215392319829"}');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src={`https://www.facebook.com/tr?id=${process.env.NEXT_PUBLIC_META_PIXEL_ID || "1038215392319829"}&ev=PageView&noscript=1`}
            alt=""
          />
        </noscript>
      </head>
